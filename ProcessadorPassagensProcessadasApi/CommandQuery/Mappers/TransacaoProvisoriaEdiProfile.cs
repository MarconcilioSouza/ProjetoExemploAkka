...
{
    public class TransacaoProvisoriaEdiProfile : Profile
    {
        public TransacaoProvisoriaEdiProfile()
        {
            CreateMap<TransacaoProvisoriaEDIDto, TransacaoPassagemLoteStaging>()
                ...
                .ForMember(d => d.DetalheTRNId, opt => opt.MapFrom(src => src.DetalheTRNId.TryToInt()))
                ...
                .ForMember(d => d.TransacaoProvisoria, opt => opt.MapFrom(src => true))
